...
<%
	...
	// 임의로 받아올 수 있는 reauest.getParameter("변수명")을 작성해주시고 변수 c에 저장한후 body에서 출력해주세요.
	String c = request.getParameter("drum");
	String d = request.getParameter("bass");
	String e = request.getParameter("guitar");
%>
<!DOCTYPE html>
<html>
<head>

<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	// cookie_login.jsp 에서 보내준 id, pw를 받아주세요.
	// post 방식임을 감안해주세요.
	...
	// 비밀번호는 "1111"인 경우에만 허용하겠습니다.(추후 DB데이터로 로그인 처리하는법 배울것임)
	// 조건문을 이용해주시면 되는데
	...
	// 라고 찍히도록 조건문을 작성해주세요. -> 로 리다이렉트 시켜주시고 콘솔대신 body에 문장을 찍으세요.
	if (id.equals("abc1234")) {
		if (pw.equals("1111")) {
			// 로그인 성공시 쿠키를 생성하고, 로그인 완료 페이지에서는 해당 쿠키를 확인하게 만들어서 로그인 여부를 감지합니다.
			// 쿠키 생성(쿠키 이름은 login_id, 값은 abc1234)
			Cookie loginId = new Cookie("login_id", "abc1234"); // 기본이 1800초다. 잊지말자.
			// 쿠키 발송
